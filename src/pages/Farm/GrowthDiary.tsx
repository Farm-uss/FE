...
const FarmStreamingPage = () => {
    ...
    const [diaryData, setDiaryData] = useState<GrowthDiaryDetail | null>(DUMMY_DATA);
    ...
    useEffect(() => {
        const fetchDiaryData = async () => {
            ...
            try {
                ...
                console.error('성장 일기를 불러오는데 실패했습니다. 더미 데이터를 표시합니다.', error);
                setDiaryData(DUMMY_DATA);
            } finally {
                setIsLoading(false);
            }
            ...
            <div className="w-full -mt-8">
                ...
                <div className="w-full flex items-center justify-between py-4">
                    <button onClick={handlePrevWeek}>
                        <Icon icon="ph:caret-left-fill" className="text-[20px] text-[#2A160C]" />
                    </button>
                    ...
                    <button onClick={handleNextWeek}>
                        <Icon icon="ph:caret-right-fill" className="text-[20px] text-[#2A160C]" />
                    </button>
                </div>
                        ...
                        <>
                            ...
                            <div className="w-full grid grid-cols-2 gap-3 mt-4">
                                ...
                                <div className="flex flex-col gap-3">
                                    <div className="bg-[#E6E0D3] rounded-[20px] p-4 flex-1 flex flex-col justify-center items-center text-center text-[#2A160C]">
                                        <div className="flex items-center justify-center gap-2 mb-1">
                                            ...
                                            <span className="text-[15px]">평균 : {diaryData.temperature.avg}도</span>
                                        </div>
                                        <div className="text-[14px] text-[#2A160C]/70 mt-1">
                                            최저 {diaryData.temperature.min}도 / 최고 {diaryData.temperature.max}도
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[#E6E0D3] rounded-[20px] px-5 py-5 text-[#2A160C] flex flex-col justify-center">
                                    <div className="font-bold mb-3 text-[16px]">
                                        성장
                                    </div>
