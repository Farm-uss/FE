    ...
    <div className="flex-1 flex flex-col items-center bg-[#E6E0D3] rounded-t-[30px] pt-6 px-6 pb-6 w-full h-[100dvh] overflow-y-auto relative">
          ...
          <div className="w-full bg-white rounded-[32px] mt-4 px-6 py-8 flex flex-col shadow-sm min-h-[420px]">
            <div className="flex flex-col items-center justify-between h-full flex-1">
              ...
              <img
                ...
                className="w-[180px] object-contain my-auto"
              />
              <div className="flex gap-4 justify-center w-full px-2 mb-2">
                <button className="bg-[#2A160C] text-white rounded-full flex-1 max-w-[150px] py-3.5 text-[18px] font-bold">
                  아니요
                </button>
                <button
                  className="bg-[#2A160C] text-white rounded-full flex-1 max-w-[150px] py-3.5 text-[18px] font-bold"
                  onClick={() => setStep(2)}
                >
                  네
                </button>
      ...
      {step === 2 && (
        <div className="w-full h-full flex flex-col pb-2">
          ...
          <p className="text-[14px] text-black/80 text-center mb-6 tracking-tight mt-2">
            자신에게 맞는 자동화 시스템을 설정하세요.
          </p>

          <div className="flex items-center mb-4 gap-4">
            <span className="text-[18px] font-bold text-black whitespace-nowrap">
              스케줄 이름
            </span>
          ...
          <div className="flex flex-col gap-5 pl-2 mb-6">
            <label
              ...
              onClick={() => setSelectedSystem('irrigation')}
            >
              <div className="flex items-center justify-center w-5 h-5 mr-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedSystem === 'irrigation' ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                ></div>
              </div>
              <svg
                className="w-[14px] h-[16px] text-[#2A160C] mr-2"
                viewBox="0 0 14 16"
                fill="currentColor"
              >
                <path d="M7 0C7 0 0 7.83333 0 11.5C0 15.0899 3.13401 16 7 16C10.866 16 14 15.0899 14 11.5C14 7.83333 7 0 7 0Z" />
              </svg>
              <span className="font-bold text-[16px] text-black w-[90px]">
                관개 시스템
              </span>
            ...
            <label
              className="flex items-center cursor-pointer"
              onClick={() => setSelectedSystem('lighting')}
            >
              <div className="flex items-center justify-center w-5 h-5 mr-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedSystem === 'lighting' ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                ></div>
              </div>
              <svg
                className="w-[14px] h-[16px] text-[#2A160C] mr-2"
            ...
            <label
              className="flex items-center cursor-pointer"
              onClick={() => setSelectedSystem('ventilation')}
            >
              <div className="flex items-center justify-center w-5 h-5 mr-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedSystem === 'ventilation' ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                ></div>
              </div>
              <svg
                className="w-[16px] h-[16px] text-[#2A160C] mr-2"
                viewBox="0 0 16 16"
                fill="currentColor"
              >
            ...
            <label
              className="flex items-center cursor-pointer"
              onClick={() => setSelectedSystem('heating')}
            >
              <div className="flex items-center justify-center w-5 h-5 mr-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedSystem === 'heating' ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                ></div>
              </div>
              <svg
                className="w-[10px] h-[16px] text-[#2A160C] mr-2 ml-1"
                viewBox="0 0 10 16"
                fill="currentColor"
              >
          ...
          <div className="mt-auto flex gap-4 justify-center w-full px-2">
            <button
              className="bg-[#2A160C] text-white rounded-[20px] flex-1 max-w-[150px] py-4 text-[16px] font-bold"
              onClick={() => setStep(1)}
            >
              이전
            </button>
      ...
      {step === 3 && (
        <div className="w-full h-full flex flex-col pb-2">
          <BottomSheetHeader title={'스케줄 추가'} description="" />
          <p className="text-[14px] text-black/80 text-center mb-6 tracking-tight shrink-0 mt-2">
            자신에게 맞는 자동화 시스템을 설정하세요.
          </p>
          ...
          <div className="flex flex-col gap-6 pl-2 mb-6 shrink-0">
            <label
              className="flex items-center cursor-pointer"
              onClick={() => setOperationMode('time')}
            >
              <div className="flex items-center justify-center w-6 h-6 mr-3">
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${operationMode === 'time' ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                ></div>
              </div>
              <svg
              ...
              <span className="font-bold text-[16px] text-black w-[80px]">
                시간 기반
              </span>
              <span className="text-[14px] text-black/90 tracking-tight">
                특정 시간에 자동으로 실행
              </span>
            </label>
            ...
            <label
              className="flex items-center cursor-pointer"
              onClick={() => setOperationMode('condition')}
            >
              <div className="flex items-center justify-center w-6 h-6 mr-3">
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${operationMode === 'condition' ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                ></div>
              </div>
              <svg
                className="w-[20px] h-[20px] mr-3"
          ...
          {operationMode === 'time' ? (
            <>
              <div className="flex items-center mb-5 gap-4 mt-2 shrink-0">
                <span className="text-[17px] font-bold text-black whitespace-nowrap">
                  실행 시간
                </span>
                <div className="h-[2px] bg-gray-300 flex-1"></div>
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    className="w-[60px] h-[45px] bg-white rounded-[12px] text-center font-bold text-[18px] outline-none shadow-sm"
                    value={executionHour}
                ...
                <div className="flex justify-between w-full">
                  {daysOfWeek.map((day) => (
                    <button
                      ...
                      className={`w-[40px] h-[40px] rounded-[12px] font-bold text-[15px] flex items-center justify-center shadow-sm transition-colors ${selectedDays.includes(day) ? 'bg-[#2A160C] text-white' : 'bg-white text-black'}`}
                    >
                      {day}
                    </button>
                  ))}
              ...
              <div className="flex items-center mb-4 gap-4 shrink-0">
                ...
                <div className="flex items-center justify-between w-[130px] h-[45px] bg-white rounded-[12px] px-3 shadow-sm">
                  <button
                    onClick={() =>
                      setOperationDuration((prev) => Math.max(0, prev - 1))
                    }
                    className="text-[24px] font-bold text-gray-400 w-[24px] flex justify-center items-center pb-1"
                  >
                    -
                  </button>
                  ...
                  <button
                    onClick={() => setOperationDuration((prev) => prev + 1)}
                    className="text-[22px] font-bold text-[#2A160C] w-[24px] flex justify-center items-center pb-0.5"
                  >
                    +
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-y-5 gap-x-2 pl-2 mb-8 shrink-0">
                {SENSORS.map((sensor) => (
                  ...
                  >
                    <div className="flex items-center justify-center w-5 h-5 mr-3">
                      <div
                        className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedSensor === sensor.id ? 'border-[#2A160C] bg-[#2A160C]' : 'border-white bg-white'}`}
                      ></div>
                    </div>
                    <span className="font-bold text-[15px] text-black shrink-0">
                      {sensor.label}
                    </span>
                    <span className="text-[13px] text-black/60 ml-2 font-medium shrink-0">
                      단위: {sensor.unit}
                    </span>
                  </label>
                ))}
